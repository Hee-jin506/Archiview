	                   ...
	                   ${c.content}
		                 ...
		                 ${c.rdtFromNow}
									    <c:choose>
									        ...
									        <button class='level-2 btn btn-outline-secondary' 
									         data-no='${count}' type="button" >답글 달기
									        </button>
										  ...
										  <img class='commentRow_more' 
										    src='${appRoot}/main_resource/more.png' alt='more'>
										  <img class='commentRow_like' 
										    src='${appRoot}/main_resource/like.png' alt='좋아요'>
							  </c:when>
							<c:otherwise>
						   	 삭제된 코멘트입니다.
						  </c:otherwise>
		...
		<div class='commentsFooter'>
			<form action="/Archiview/app/comment/add" method="post" class="register">
				...
				<input class="form-control form-control-sm" 
				  type="text" placeholder="댓글 달기" name='content'>
			</form>
		</div>
  </div>
