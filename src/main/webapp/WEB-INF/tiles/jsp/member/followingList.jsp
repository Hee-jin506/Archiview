 ...
 <div id="profile_icon_report">
    ...
    <div id="profile_icon">
      <a href="${appRoot}/app/member/profile?no=${member.no}"> 
        <img class=profile_icon  src="${appRoot}/profile_resource/review-border.png" height=30px class="center" alt="리뷰">
      ...
      <a href="${appRoot}/app/member/followingList?no=${member.no}"> 
        <img class=profile_icon  src="${appRoot}/profile_resource/following.png" height=30px class="center" alt="팔로잉">
