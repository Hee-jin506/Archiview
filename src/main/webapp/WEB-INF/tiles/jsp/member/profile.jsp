...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> 
 ...
 <div class="modal fade" id="reportWindow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
var reportModal = new bootstrap.Modal(document.getElementById('reportWindow'), {});
var reportExampleModal = document.querySelector("#reportWindow");
var exampleModalBody = exampleModal.querySelector(".modal-body");
var memberNo;
reportExampleModal.addEventListener('show.bs.modal', function (event) {
  console.log("show.bs.modal")
  $(".modal-body").load("/Archiview/app/ajax/report/form?reportedNo=" + memberNo);
  
});
reportExampleModal.addEventListener('shown.bs.modal', function (event) {
  console.log("shown.bs.modal")
});
reportExampleModal.addEventListener('hidden.bs.modal', function (event) {
