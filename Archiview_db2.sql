...
CREATE TABLE acv_mov (
	...
	rdt       DATETIME    NULL     DEFAULT now() COMMENT '등록일', -- 등록일
...
CREATE TABLE acv_post (
	...
	text  MEDIUMTEXT NOT NULL COMMENT '텍스트', -- 텍스트
...
ALTER TABLE acv_post
	MODIFY COLUMN pno INTEGER NOT NULL AUTO_INCREMENT COMMENT '게시물 번호';
...
ALTER TABLE acv_ctr
	MODIFY COLUMN cno INTEGER NOT NULL AUTO_INCREMENT COMMENT '국가 번호';
...
ALTER TABLE acv_mg
	MODIFY COLUMN mgno INTEGER NOT NULL AUTO_INCREMENT COMMENT '관리자 번호';
...
ALTER TABLE acv_user
	MODIFY COLUMN uno INTEGER NOT NULL AUTO_INCREMENT COMMENT '사용자 번호';
